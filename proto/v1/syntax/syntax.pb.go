...
func (*ParsedExpr) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{0}
}
...
func (*Expr) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1}
}
...
func (*Expr_Ident) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 0}
}
...
func (*Expr_Select) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 1}
}
...
func (*Expr_Call) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 2}
}
...
func (*Expr_CreateList) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 3}
}
...
func (*Expr_CreateStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 4}
}
...
func (*Expr_CreateStruct_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 4, 0}
}
...
func (*Expr_Comprehension) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{1, 5}
}
...
func (*Literal) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{2}
}
...
type isLiteral_LiteralKind interface {
	isLiteral_LiteralKind()
}
...
func (*Literal_NullValue) isLiteral_LiteralKind()   {}
func (*Literal_BoolValue) isLiteral_LiteralKind()   {}
func (*Literal_Int64Value) isLiteral_LiteralKind()  {}
func (*Literal_Uint64Value) isLiteral_LiteralKind() {}
func (*Literal_DoubleValue) isLiteral_LiteralKind() {}
func (*Literal_StringValue) isLiteral_LiteralKind() {}
func (*Literal_BytesValue) isLiteral_LiteralKind()  {}

func (m *Literal) GetLiteralKind() isLiteral_LiteralKind {
	if m != nil {
		return m.LiteralKind
	}
	return nil
}

func (m *Literal) GetNullValue() _struct.NullValue {
	if x, ok := m.GetLiteralKind().(*Literal_NullValue); ok {
		return x.NullValue
	}
...
func (m *Literal) GetBoolValue() bool {
	if x, ok := m.GetLiteralKind().(*Literal_BoolValue); ok {
		return x.BoolValue
	}
	return false
}
...
func (m *Literal) GetInt64Value() int64 {
	if x, ok := m.GetLiteralKind().(*Literal_Int64Value); ok {
		return x.Int64Value
	}
	return 0
}
...
func (m *Literal) GetUint64Value() uint64 {
	if x, ok := m.GetLiteralKind().(*Literal_Uint64Value); ok {
...
func (m *Literal) GetDoubleValue() float64 {
	if x, ok := m.GetLiteralKind().(*Literal_DoubleValue); ok {
...
func (m *Literal) GetStringValue() string {
	if x, ok := m.GetLiteralKind().(*Literal_StringValue); ok {
...
func (m *Literal) GetBytesValue() []byte {
	if x, ok := m.GetLiteralKind().(*Literal_BytesValue); ok {
		return x.BytesValue
	}
	return nil
}
...
func _Literal_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("Literal.LiteralKind has unexpected type %T", x)
	}
	return nil
}
...
func _Literal_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Literal)
	switch tag {
	case 1: // literal_kind.null_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LiteralKind = &Literal_NullValue{_struct.NullValue(x)}
		return true, err
	case 2: // literal_kind.bool_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LiteralKind = &Literal_BoolValue{x != 0}
		return true, err
	case 3: // literal_kind.int64_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LiteralKind = &Literal_Int64Value{int64(x)}
		return true, err
	case 4: // literal_kind.uint64_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.LiteralKind = &Literal_Uint64Value{x}
		return true, err
	case 5: // literal_kind.double_value
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.LiteralKind = &Literal_DoubleValue{math.Float64frombits(x)}
		return true, err
	case 6: // literal_kind.string_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.LiteralKind = &Literal_StringValue{x}
		return true, err
	case 7: // literal_kind.bytes_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.LiteralKind = &Literal_BytesValue{x}
		return true, err
	default:
		return false, nil
	}
...
func (*SourceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_syntax_81221061a4e314d3, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*Literal)(nil), "google.api.expr.v1.Literal")
	proto.RegisterType((*SourceInfo)(nil), "google.api.expr.v1.SourceInfo")
	proto.RegisterMapType((map[int64]int32)(nil), "google.api.expr.v1.SourceInfo.PositionsEntry")
}

func init() { proto.RegisterFile("proto/v1/syntax.proto", fileDescriptor_syntax_81221061a4e314d3) }

var fileDescriptor_syntax_81221061a4e314d3 = []byte{
	...
	,
}
